...
export class CreateAdminAndStaffTables1776862541327 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_staff_email" ON "staff" ("email") WHERE deleted_at IS NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "staff_security_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "staff_id" uuid, "staff_name" character varying, "action_type" character varying NOT NULL, "description" text, "ip" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c48e5a0135975c8285da6594604" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_staff_security_logs_created_at" ON "staff_security_logs" ("created_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_staff_security_logs_action_type" ON "staff_security_logs" ("action_type") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_staff_security_logs_staff_id" ON "staff_security_logs" ("staff_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "staff" ADD CONSTRAINT "FK_c3fe01125c99573751fe5e55666" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_security_logs" ADD CONSTRAINT "FK_c692e3ea95b56928043bb60a942" FOREIGN KEY ("staff_id") REFERENCES "staff"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_refresh_tokens" ADD CONSTRAINT "FK_a8a1ae310391e175124623e1850" FOREIGN KEY ("staff_id") REFERENCES "staff"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_security_logs" ADD CONSTRAINT "FK_76ffde0d49c993040f230ef87d5" FOREIGN KEY ("admin_id") REFERENCES "admins"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_security_logs" DROP CONSTRAINT "FK_76ffde0d49c993040f230ef87d5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_refresh_tokens" DROP CONSTRAINT "FK_a8a1ae310391e175124623e1850"`,
    );
    await queryRunner.query(
      `ALTER TABLE "staff_security_logs" DROP CONSTRAINT "FK_c692e3ea95b56928043bb60a942"`,
    );
